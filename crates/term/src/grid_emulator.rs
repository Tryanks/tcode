...
impl GridEmulator {
    ...
    pub fn resize_if_changed(&self, cols: usize, rows: usize) -> bool {
    ...
    /// Read lifecycle state without consuming renderer damage.
    pub fn exited(&self) -> bool {
        self.core.lifecycle.lock_recover().exited
    }
